        ...
        {/* Parent div of Hero Section */}
            <div className='lg:h-screen lg:w-screen flex flex-col items-center -mb-10 gap-y-5'>
                <div className='flex flex-row justify-between items-center lg:h-17.5 px-5 py-2 gap-x-4 mt-15 bg-amber-50 lg:w-137.5 rounded-2xl'>
                    ...
                    <button onClick={() => navigate('/')} className='text-lg text-gray-800 hover:bg-[#EDE8E8] transition-all ease-in lg:w-37.5 lg:h-11.25 rounded-2xl'>Home</button>
                    <button onClick={() => navigate('/signup')} className='text-lg font-semibold text-gray-800 bg-yellow-300 cursor-pointer lg:w-37.5 lg:h-11.25 rounded-2xl hover:shadow-neutral-500 hover:shadow-lg hover:scale-105 transition-all ease-out'>Signup</button>
                    <button onClick={() => navigate('/login')} className='text-lg font-semibold text-gray-800 bg-yellow-300 cursor-pointer lg:w-37.5 lg:h-11.25 rounded-2xl hover:shadow-neutral-500 hover:shadow-lg hover:scale-105 transition-all ease-out'>Login</button>
                </div>
          ...
          <div className={`flex flex-wrap justify-center gap-10 bg-[#5B5FC7] relative z-10`}>
          ...
          <div ref={footerRef} className={`lg:h-100 pt-30 ${active ? "translate-0 opacity-100 transition-all ease-out delay-100" : "translate-x-100 opacity-0"}`}>
